...
```bash
wget -O - https://raw.githubusercontent.com/iwaking2024/HADES-BOT-OMEGA/master/install.sh | bash
```
...
```bash
git clone https://github.com/iwaking2024/HADES-BOT-OMEGA.git && cd HADES-BOT-OMEGA
```
